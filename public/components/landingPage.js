...
const createHeader = () => {
    ...
    const forkKnifeIcon = htmlCreator.createImg('./assets/icons/fork-knife.svg');

    const headerCentralContainer = htmlCreator.createDiv('header-central-container');
    ...
    const loginButton = htmlCreator.createButton('login', 'login-btn', 'header-button');
    const registerButton = htmlCreator.createButton( 'cadastrar','register-btn', 'header-button');
...
const createContentSection = () => {
    ...
    const registerButton = htmlCreator.createButton('Cadastre-se', 'main-register-button');
